...
interface UiState { tab: "wego" | "we" | "together" | "story"; sheet: Sheet; revealOpen: boolean; shareStoryId: string | null; openSheet: (sheet: Exclude<Sheet, null>) => void; closeSheet: () => void; openReveal: () => void; closeReveal: () => void; openShare: (id: string) => void; closeShare: () => void; setTab: (tab: UiState["tab"]) => void; }
